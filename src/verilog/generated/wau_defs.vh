...
`define WAU_HIGHWAY_TOPOLOGY_LINES 1
`define WAU_HIGHWAY_TOPOLOGY_NAME "lines"
`define WAU_HIGHWAY_PORT_COUNT 3
`define WAU_HIGHWAY_LINE_COUNT 2
`define WAU_HIGHWAY_LINE_SIZE 3
