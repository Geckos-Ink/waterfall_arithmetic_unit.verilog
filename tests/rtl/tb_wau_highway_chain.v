...
// Owns the "chain" highway contract: on a multi-row grid
...
module tb_wau_highway_chain;
    ...
    initial begin
        ...
        if ((router_hop_count[(0*32) +: 32]
            ...
            $display("FAIL: chain highway router_hop_count never advanced");
            $fatal(1);
        end
        ...
        $display("PASS: tb_wau_highway_chain");
        $finish;
    end
endmodule
